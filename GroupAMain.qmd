...
Showing that JWDP stores many unique variables (149) and showing a value (row 10000) where it's not "NA" (in datetime format). Also showing the factor levels for HHL.
