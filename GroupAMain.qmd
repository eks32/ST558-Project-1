...
```{r}
multi_year_data <- Pums_multiYearData(years = c(2022,2023), num_variables = c("AGEP", "PWGTP","JWAP"))
multi_year_data
```

### Summary function
Cleans up our tibble with column proper names for our variables and filtering factors like Sex. It also returns a summary with the mean/std/counts of our variables.
